...
async def start_hero():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await idk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await ydk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await wdk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await hdk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await sdk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await adk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await bdk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await cdk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await ddk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@WEIRD_FEELS"))
            await edk(functions.channels.JoinChannelRequest(channel="@empire_of_dark_cobra"))
