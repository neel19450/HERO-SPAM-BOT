...
async def start_hero():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
            await idk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
            await ydk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
            await wdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
            await hdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
            await sdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
            await adk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
            await bdk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighterst"))
            await cdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
            await ddk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@ind_branded_fighters"))
            await edk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS"))
