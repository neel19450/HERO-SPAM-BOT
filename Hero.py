...
async def start_hero():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await idk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await ydk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await wdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await hdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await sdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await adk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await bdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await cdk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await ddk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_OP"))
            await edk(functions.channels.JoinChannelRequest(channel="@HERO_FIGHTERS_1"))
